...
class ChannelDetailsWidget extends StatelessWidget {
  ...
  ChannelDetailsWidget (this.activeChannel, { @required this.onEditChannelPressed, @required this.onInvitePressed, @required this.onNotificationSettingsPressed,
  ...
  Widget _buildCell({
    ...
    return Visibility(visible: requiresAdmin ? activeChannel.isUserAdmin : true, child: Container(child: BaseCell(
      leading: leading,
