...
class HomeAppBarBuilder {
  ...
  HomeAppBarBuilder ({ @required this.onDrawerButtonPressed, @required this.onShowSearchPressed, @required this.onMyProfilePressed,
    @required this.onPerformSearchPressed, @required this.onCancelSearchPressed, @required this.homeManager, this.isSearch = false
  }) {
  ...
  PreferredSizeWidget _buildDefaultAppBar() {
    return AppBar(
        ...
        actions: <Widget>[
          ScopedModel<HomeManager>(
            model: this.homeManager,
